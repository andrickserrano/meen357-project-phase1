...
bounds = Bounds([14.8, 0.60, 270, 0.05, 210],
                [15.2, 0.70, 290, 0.055, 230])

x0 = np.array([14.9, 0.70, 280.0, 0.05, 230.0])
...
if feasible:
    ...
    print("WARNING: Solution not feasible")
    xbest = res.x
...
edl_system['team_name'] = 'superdupergoatedteam'  # change this to something fun for your team (or just your team number)
edl_system['team_number'] = 53    # change this to your assigned team number (also change it below when saving your pickle file)

# This will create a file that you can submit as your competition file.
with open('FA25_501team53.pickle', 'wb') as handle:
