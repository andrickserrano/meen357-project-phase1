...
# Extract terrain data from the experiment dic
alpha_dist = experiment['alpha_dist']  # data points m
alpha_deg  = experiment['alpha_deg']   # terrain angle data deg
 
# Create cubic interpolation function for terrain angle vs distance
...
# Format for better looking grpah
